...
<body>
	<div class="div_head">
		<span> <span style="float: left">当前位置是：-》培训管理 -》修改培训计划</span> <span
			style="float: right; margin-right: 8px; font-weight: bold"> <a
				style="text-decoration: none" href="peixun/info?pageNum=${param.pageNum }">【返回】</a>
		</span>
		</span>
	</div>
	<div></div>
	...
	<div style="font-size: 13px; margin: 10px 5px">
		<form action="peixun/add?pageNum=pageNum" method="post"
			...
			<table border="1" width="100%" class="table_a">
				...
				<tr>
					...
					<td><input type="text" name="tarTeacher" value="" />
					<span></span></td>
				</tr>
				...
				<tr>
					...
					<td><textarea name=tarResouce></textarea>
					<span></span></td>
				</tr>
				...
				<tr>
					...
					<td><textarea name="tarEmployee"></textarea>
					<span></span>
					</td>
				</tr>
				...
				<tr>
					<td>培训简介：</td>
					<td><textarea name="tarIntro" value=""></textarea>
					<span></span>
					</td>
				</tr>
				...
				<tr>
					<td>培训资料：</td>
					<td><input type="text" name="tarFile" value="" />
					<span></span></td>
				</tr>

				<tr>
					<td colspan="2" align="center">
					<input type="button" id="bt" value="保存">
