        ...
        <div class="div_head">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="res/eg">【返回】</a>
                </span>
            </span>
        </div>
        <div></div>
            ...
            <table border="1" width="100%" class="table_a">
                 <tr>
					...
					<select>
						<option>---请选择---</option>
						<option>---技术培训师---</option>
						<option selected="selected">---研发工程师---</option>
					</select>
                ...
                <tr>
                    <td>应聘职位编码：</td>
                    <td>
                       <input type="text" name="f_goods_name" readonly="readonly" value="a1006" /> 
                    </td>
                </tr>
                ...
                <tr>
                    <td>职位分类：</td>
                    <td>
						<input type="text" name="f_goods_price"  readonly="readonly" value="技术"/></td>
                </tr>
                <tr>
                    <td>姓名：</td>
                    <td>
